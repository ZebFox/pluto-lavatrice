...
typedef enum {
    ...
    STRINGS_CHIAVE_PER_ESPORTARE,
    STRINGS_CHIAVE_PER_ESPORTARE_BANDIERA_PER_IMPORTARE,
    STRINGS_CONFIGURAZIONE_ESPORTATA,
    STRINGS_OPERAZIONE_IN_CORSO,
    STRINGS_CONFIGURAZIONE_CARICATA_CON_SUCCESSO,
    STRINGS_ERRORE_NEL_CARICAMENTO_DELLA_CONFIGURAZIONE,
    STRINGS_ERRORE_NEL_SALVATAGGIO_DELLA_CONFIGURAZIONE,
    STRINGS_APRI_E_SVUOTA,
